...
ERS_FILES_LOCATION = Path("/opt2/monitorenv-data/ers")
...
# App URL
MONITORENV_HOST = os.getenv("MONITORENV_HOST")  # monitor.fish
MONITORENV_IP = os.getenv("MONITORENV_IP")  # 1.2.3.4
MONITORENV_URL = os.getenv("MONITORENV_URL")  # http://monitor.fish/
BACKOFFICE_URL = MONITORENV_URL + "backoffice/"

# Backend endpoints
BFF_ENDPOINT = MONITORENV_URL + "bff/v1/"
...
# Email server
MONITORENV_EMAIL_SERVER_URL = os.environ.get("MONITORENV_EMAIL_SERVER_URL")
MONITORENV_EMAIL_SERVER_PORT = os.environ.get("MONITORENV_EMAIL_SERVER_PORT")
MONITORENV_EMAIL_ADDRESS = os.environ.get("MONITORENV_EMAIL_ADDRESS")
