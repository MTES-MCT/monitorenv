...
context('Recent Activity -> Filters', () => {
  ...
  it('Menu button should show the number of filter set', () => {
    ...
    cy.getDataCy('recent-activity-number-filters').contains('1')
    cy.fill('Administration', ['DDTM'])
    cy.getDataCy('recent-activity-number-filters').contains('2')
    cy.fill('Unité', ['DML 2A'])
    cy.getDataCy('recent-activity-number-filters').contains('3')
    cy.fill('Thématique', ['Mouillage individuel'])
    cy.getDataCy('recent-activity-number-filters').contains('4')
    cy.clickButton('Définir un tracé pour la zone à filtrer')
    ...
    cy.get('#root').click(490, 180)
    cy.clickButton('Valider la zone à filtrer')
    cy.getDataCy('recent-activity-number-filters').contains('5')
    ...
    cy.getDataCy('recent-activity-number-filters').should('not.exist')
  })
})
