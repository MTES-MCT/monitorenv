...
export const MISSION_FORM_AUTO_UPDATE_ENABLED =
...
export const MISSION_FORM_AUTO_SAVE_ENABLED =
  self?.env?.REACT_APP_MISSION_FORM_AUTO_SAVE_ENABLED !== '__REACT_APP_MISSION_FORM_AUTO_SAVE_ENABLED__'
    ? self.env.REACT_APP_MISSION_FORM_AUTO_SAVE_ENABLED
    : process.env.REACT_APP_MISSION_FORM_AUTO_SAVE_ENABLED

export const MONITORFISH_PUBLIC_URL =
  self?.env?.REACT_APP_MONITORFISH_PUBLIC_URL !== '__REACT_APP_MONITORFISH_PUBLIC_URL__'
    ? self.env.REACT_APP_MONITORFISH_PUBLIC_URL
    : process.env.REACT_APP_MONITORFISH_PUBLIC_URL

export const MONITORFISH_PROTECTED_API_KEY =
  self?.env?.REACT_APP_MONITORFISH_PROTECTED_API_KEY !== '__REACT_APP_MONITORFISH_PROTECTED_API_KEY__'
    ? self.env.REACT_APP_MONITORFISH_PROTECTED_API_KEY
    : process.env.REACT_APP_MONITORFISH_PROTECTED_API_KEY
