...
export enum MonitorEnvLayers {
  ...
  REGULATORY_LINKED_TO_VIGILANCE_AREA = 'REGULATORY_LINKED_TO_VIGILANCE_AREA',
...
export const Layers: Record<MonitorEnvLayers, Layer> = {
  ...
  [MonitorEnvLayers.REGULATORY_LINKED_TO_VIGILANCE_AREA]: {
    code: MonitorEnvLayers.REGULATORY_LINKED_TO_VIGILANCE_AREA,
    zIndex: 1600
  }
}
