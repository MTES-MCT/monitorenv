...
import { monitorenvPrivateApi, monitorenvPublicApi, geoserverApi, monitorFishPublicApi } from '../api/api'
...
const homeStore = configureStore({
  ...
  middleware: getDefaultMiddleware =>
    getDefaultMiddleware({
      ...
      monitorenvPrivateApi.middleware,
      monitorenvPublicApi.middleware,
