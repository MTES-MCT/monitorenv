...
import { CONTROL_UNIT_FORM_SCHEMA, INITIAL_CONTROL_UNIT_FORM_VALUES } from './constants'
...
export function ControlUnitForm() {
  ...
  const goBackToList = useCallback(() => {
    navigate(`/backoffice${BACK_OFFICE_MENU_PATH[BackOfficeMenu.CONTROL_UNIT_LIST]}`)
  }, [navigate])
