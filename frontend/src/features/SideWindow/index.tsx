...
import { ReportingsOnSideWindow } from '../Reportings/sideWindowContext'
import { SideWindowReportingFormVisibility, SideWindowReportingsContext } from '../Reportings/sideWindowContext/context'
...
function SideWindowWithRef(_, ref: ForwardedRef<HTMLDivElement | null>) {
  ...
  const [visibility, setVisibility] = useState(SideWindowReportingFormVisibility.NONE)

  const setContextVisibility = useCallback(nextVisibility => {
  ...
  const contextValue = useMemo(
    ...
    [setContextVisibility, visibility]
  )
  ...
  return (
    <ErrorBoundary>
      <SideWindowReportingsContext.Provider value={contextValue}>
        <Wrapper ref={wrapperRef}>
          ...
          <ReportingsOnSideWindow />
          <ToastContainer containerId="sideWindow" enableMultiContainer />
        </Wrapper>
      </SideWindowReportingsContext.Provider>
    </ErrorBoundary>
  )
}
