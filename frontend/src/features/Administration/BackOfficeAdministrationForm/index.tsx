...
import { administrationApi, useGetAdministrationQuery } from '../../../api/administration'
...
export function BackOfficeAdministrationForm() {
  ...
  const submit = useCallback(
    async (administrationFormValues: AdministrationFormValues) => {
      ...
      if (isNew) {
        await dispatch(administrationApi.endpoints.createAdministration.initiate(administrationData))
      ...
      await dispatch(
        administrationApi.endpoints.updateAdministration.initiate({
