...
export type MissionInStateType = {
  ...
  isFormDirty: boolean
  missionForm: AtLeast<Partial<Mission.Mission>, 'id'> | Partial<Mission.NewMission>
}
...
const missionFormsSlice = createSlice({
  ...
  reducers: {
    ...
    updateUnactiveMission(state, action: PayloadAction<AtLeast<Partial<Mission.Mission>, 'id'>>) {
