...
const infractionTypeOptions = Object.values(Mission.infractionTypeLabels).map(o => ({
  label: o.libelle,
  value: o.code
}))
const formalNoticeOPtions = Object.values(Mission.formalNoticeLabels).map(o => ({ label: o.libelle, value: o.code }))
