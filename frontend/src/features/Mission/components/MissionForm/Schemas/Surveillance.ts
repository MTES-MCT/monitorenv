...
export const getNewEnvActionSurveillanceSchema = (ctx: any): Yup.SchemaOf<Mission.EnvActionSurveillance> =>
  Yup.object()
    .shape({
      ...
      actionType: Yup.mixed().oneOf([Mission.ActionTypeEnum.SURVEILLANCE]),
...
export const getCompletionEnvActionSurveillanceSchema = (ctx: any): Yup.SchemaOf<Mission.EnvActionSurveillance> =>
  Yup.object()
    .shape({
      actionEndDateTimeUtc: Yup.date()
        .nullable()
