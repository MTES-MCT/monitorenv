...
export const getNewEnvActionControlSchema = (ctx: any): Yup.SchemaOf<Mission.EnvActionControl> =>
  Yup.object()
    .shape({
      ...
      actionType: Yup.mixed().oneOf([Mission.ActionTypeEnum.CONTROL]),
...
export const getCompletionEnvActionControlSchema = (ctx: any): Yup.SchemaOf<Mission.EnvActionControl> =>
  Yup.object()
    .shape({
