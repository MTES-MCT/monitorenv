...
type MissionFormProps = {
  ...
  selectedMission: AtLeast<Partial<Mission.Mission>, 'id'> | Partial<Mission.NewMission> | undefined
...
export function MissionForm({
  ...
  const [actionsSources, setActionsSources] = useState<Mission.MissionSourceEnum[]>([])
  ...
  return (
    <StyledFormContainer>
      {missionCompletionFrontStatus === Mission.FrontCompletionStatus.TO_COMPLETE_MISSION_ENDED && (
        <Banner
          closingDelay={10000}
          isClosable={false}
          isCollapsible
