    ...
    <StyledContainer data-cy="missions-filter-tags">
      ...
      {selectedMissionTypes &&
        ...
        selectedMissionTypes.map(type => (
          ...
          >
            {String(`Type ${Mission.missionTypeLabels[type].libelle}`)}
          </SingleTag>
        ))}
      {selectedThemes &&
      ...
      {selectedStatuses &&
        ...
        selectedStatuses.map(status => (
          ...
          >
            {String(`Mission ${Mission.missionStatusLabels[status].libelle.toLowerCase()}`)}
          </SingleTag>
        ))}
      {selectedCompletionStatus &&
        ...
        selectedCompletionStatus.map(completionStatus => (
          ...
          >
            {String(`Données ${Mission.FrontCompletionStatusLabel[completionStatus].toLowerCase()}`)}
          </SingleTag>
        ))}
    </StyledContainer>
  )
