...
export function MissionsTableFilters() {
  ...
  const missionStatusesAsOptions = getOptionsFromLabelledEnum(Mission.MissionStatusLabel)
  const missionTypesAsOptions = getOptionsFromLabelledEnum(Mission.MissionTypeLabel)
  const seaFrontsAsOptions = Object.values(seaFrontLabels)
  const completionStatusAsOptions = getOptionsFromLabelledEnum(Mission.FrontCompletionStatusLabel)
