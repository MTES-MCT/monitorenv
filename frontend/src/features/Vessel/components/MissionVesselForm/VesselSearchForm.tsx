...
export function VesselSearchForm({
  ...
  const clear = useCallback(() => {
    setFieldValue(`${path}.vesselShipId`, undefined)
    setFieldValue(`${path}.vesselBatchId`, undefined)
    setFieldValue(`${path}.vesselRowNumber`, undefined)
    ...
    if (vesselIdentity) {
      await getVessel({
        ...
        .then(vesselFound => {
          ...
          setFieldValue(`${path}.vesselShipId`, vesselFound.shipId)
          setFieldValue(`${path}.vesselBatchId`, vesselFound.batchId)
          setFieldValue(`${path}.vesselRowNumber`, vesselFound.rowNumber)
