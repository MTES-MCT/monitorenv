...
export const regions = [
  ...
  { code: '02', departements: ['21', '25', '39', '58', '70', '71', '89', '90'], nom: 'Bourgogne-Franche-Comté' },
  { code: '03', departements: ['22', '29', '35', '56'], nom: 'Bretagne' },
  { code: '04', departements: ['18', '28', '36', '37', '41', '45'], nom: 'Centre-Val de Loire' },
  { code: '06', departements: ['2A', '2B'], nom: 'Corse' },
  { code: '11', departements: ['75', '77', '78', '91', '92', '93', '94', '95'], nom: 'Île-de-France' },
  { code: '24', departements: ['14', '27', '50', '61'], nom: 'Normandie' },
  {
    code: '27',
    departements: ['16', '17', '19', '23', '24', '33', '40', '47', '64', '79', '86', '87'],
    nom: 'Nouvelle-Aquitaine'
  },
  { code: '28', departements: ['09', '11', '12', '30', '31', '32', '34', '46', '48', '65', '66'], nom: 'Occitanie' },
  { code: '32', departements: ['44', '49', '53', '72', '85'], nom: 'Pays de la Loire' },
  { code: '44', departements: ['04', '05', '06', '13', '83', '84'], nom: "Provence-Alpes-Côte d'Azur" }
]
