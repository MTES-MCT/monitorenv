...
insert into public.regulatory_areas (id, geom,ref_reg, edition_cacem, row_hash) values (1, 'MULTIPOLYGON(((0 0,10 0,10 10,0 10,0 0)))', 'ref_reg1', '2025-01-01', '4ccc708e6a0c4f311dd7e537e282f7f6');
insert into public.regulatory_areas (id, geom,ref_reg, edition_cacem, row_hash) values (2, 'MULTIPOLYGON(((120 -20,135 -20,135 -10,120 -10,120 -20)))', 'ref_reg2', '2025-01-01', '8c3842144dfaf46ead39bfa628dd9513');
