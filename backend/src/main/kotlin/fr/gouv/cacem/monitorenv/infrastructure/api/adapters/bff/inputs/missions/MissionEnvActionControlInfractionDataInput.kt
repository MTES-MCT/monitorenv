...
data class MissionEnvActionControlInfractionDataInput(
    ...
    val vesselShipId: Int? = null,
    val vesselBatchId: Int? = null,
    val vesselRowNumber: Int? = null,
    ...
    fun toInfractionEntity() =
        InfractionEntity(
            ...
            seizure = seizure,
            vesselShipId = vesselShipId,
            vesselBatchId = vesselBatchId,
            vesselRowNumber = vesselRowNumber,
