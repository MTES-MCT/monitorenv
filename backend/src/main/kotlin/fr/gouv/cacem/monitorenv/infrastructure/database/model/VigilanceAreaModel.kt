...
data class VigilanceAreaModel(
    ...
    val endDatePeriod: Instant? = null,
    ...
    @Column(name = "ending_occurence_date")
    val endingOccurenceDate: Instant? = null,

    @Column(name = "ending_occurence_number")
    ...
    val startDatePeriod: Instant? = null,
    ...
    companion object {
        fun fromVigilanceArea(vigilanceArea: VigilanceAreaEntity): VigilanceAreaModel {
            return VigilanceAreaModel(
                ...
                endingOccurenceDate = vigilanceArea.endingOccurenceDate?.toInstant(),
    ...
    fun toVigilanceAreaEntity(): VigilanceAreaEntity {
        return VigilanceAreaEntity(
            ...
            endingOccurenceDate = endingOccurenceDate?.atZone(UTC),
