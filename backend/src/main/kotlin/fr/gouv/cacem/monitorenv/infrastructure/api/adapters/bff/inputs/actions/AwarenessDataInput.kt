...
class AwarenessDataInput(private val isRisingAwareness: Boolean, val themeId: Int?, private val nbPerson: Int?) {
    fun toAwarenessEntity(): AwarenessEntity {
        return AwarenessEntity(isRisingAwareness = isRisingAwareness, themeId = themeId, nbPerson = nbPerson)
    }
}
