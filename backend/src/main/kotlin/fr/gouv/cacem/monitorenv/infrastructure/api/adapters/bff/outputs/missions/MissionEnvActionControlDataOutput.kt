...
data class MissionEnvActionControlDataOutput(
    ...
    companion object {
        fun fromEnvActionControlEntity(
            ...
            isComplianceWithWaterRegulationsControl = envActionControlEntity.isComplianceWithWaterRegulationsControl,
            isSafetyEquipmentAndStandardsComplianceControl = envActionControlEntity.isSafetyEquipmentAndStandardsComplianceControl,
