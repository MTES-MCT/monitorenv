...
import fr.gouv.cacem.monitorenv.infrastructure.database.repositories.JpaInfractionsObservationsReportRepository
...
class GetHealthcheck(
    ...
    private val infractionsObservationsReportRepository: JpaInfractionsObservationsReportRepository,
) {
    fun execute(): Health {
        ...
        val numberOfInfractionsObservationsReports = infractionsObservationsReportRepository.count()
        ...
        return Health(
            ...
            numberOfInfractionsObservationsReports = numberOfInfractionsObservationsReports,
        )
    }
}
