...
class Themes(
    ...
    private val saveThemes: SaveTheme,
) {
    @GetMapping("")
    ...
    @Operation(summary = "create or update the given theme")
    fun put(
        @RequestBody themeInput: CreateOrUpdateThemeInput,
    ): ThemeOutput = ThemeOutput.fromThemeEntity(saveThemes.execute(themeInput.toThemeEntity()))
}
