...
-- 3. Date dans les trois prochains mois
        date_within_year_and_3_months := date_trunc('month', CURRENT_DATE) + INTERVAL '3 months';
        ...
        VALUES (1, 'Commentaire sur la zone de vigilance', 'ABC',
            ...
            ]', 'Zone de vigilance 1', 'Unité BSN Ste Maxime',
        ...
        VALUES (2, 'Des dauphins partout', 'DEF', date_within_year_and_3_months + INTERVAL '1 day',
                'END_DATE',
                ...
                false, NULL, 'Zone de vigilance 2', 'Unité PAM Themis',
                date_within_year_and_3_months - INTERVAL '1 day', '{"AMP","Mixte"}',
                'PRIVATE', '{}', '{"625", "425"}',
                date_within_year_and_3_months + INTERVAL '6 year');
        ...
        INSERT INTO public.vigilance_areas(id, comments, created_by, end_date_period, ending_condition,
                                           ...
                                           start_date_period, themes, visibility, linked_amps, linked_regulatory_areas,
                                           computed_end_date)
        VALUES (3, 'comments', 'GHI', date_within_quarter + INTERVAL '1 day',
            ...
            ]', 'Zone de vigilance 3', 'Particulier qui était sur les lieux',
                date_within_quarter - INTERVAL '1 day', '{"PN","SAGE"}',
                'PUBLIC', '{}', '{}',
        ...
        VALUES (4,
                ...
                'JKL', date_within_year_not_in_quarter_nor_3_months + INTERVAL '1 day', 'END_DATE',
                ...
                false, NULL, 'Zone de vigilance 4', 'CACEM',
        ...
        VALUES (9, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'JKL',
                ...
                false, NULL, 'Zone de vigilance 9', 'CACEM',
        ...
        VALUES (5,
                ...
                'ABC', today - INTERVAL '1 day', NULL, NULL, NULL,
                'NONE',
                ...
                true, NULL, 'Zone de vigilance 5', NULL, today - INTERVAL '1 month',
                '{"AMP","PN"}', 'PRIVATE', '{}', '{}',
                today - INTERVAL '1 day');
        ...
        INSERT INTO public.vigilance_areas(id, comments, created_by, end_date_period, ending_condition,
                                           ...
                                           computed_end_date)
        -- period : within 3 months
        VALUES (6, NULL, 'DEF', date_within_year_and_3_months + INTERVAL '1 day', 'NEVER',
                NULL,
                NULL, 'ALL_YEARS',
            ...
            ]', 'Zone de vigilance 6', 'Unité BSN Ste Maxime',
                date_within_year_and_3_months - INTERVAL '1 day',
                NULL, 'PUBLIC', '{}', '{}', NULL);
        ...
        VALUES (7,
                ...
                'GHI', date_within_quarter + INTERVAL '1 day', 'OCCURENCES_NUMBER', NULL,
                6,
                'ALL_WEEKS',
                ...
                NULL, NULL, '{}', '{}',
                date_within_quarter + INTERVAL '42 day');
        ...
        VALUES (8, 'Phasellus ac elit eget ex blandit varius.', 'JKL',
                date_within_year_not_in_quarter_nor_3_months + INTERVAL '1 day', 'END_DATE',
                '2099-12-31 23:59:59.99999', NULL, 'ALL_MONTHS',
