...
-- 3. Date dans les trois prochains mois
        ...
        VALUES (1, 'Commentaire sur la zone de vigilance', 'ABC',
                ...
                false, '[
            {
              ...
              "linkUrl": "www.google.fr"
                ...
                '{"Dragage","Extraction granulats"}', 'PUBLIC', '{"12", "6"}', '{}', now() - INTERVAL '15 day', now());
        ...
        VALUES (2, 'Des dauphins partout', 'DEF',
                ...
                '{"AMP","Mixte"}',
                'PRIVATE', '{}', '{"625", "425"}', now() - INTERVAL '35 day', now() - INTERVAL '2 day');
        ...
        VALUES (3, 'comments', 'GHI',
            ...
            },
            {
              ...
              "linkUrl": "www.google.fr"
                ...
                'PUBLIC', '{}', '{}', now() - INTERVAL '40 day', now() - INTERVAL '35 day');
        ...
        VALUES (4,
                ...
                '{"AMP","PN"}', 'PRIVATE', '{}', '{}', now() - INTERVAL '10 day', NULL);
        ...
        VALUES (8, 'Phasellus ac elit eget ex blandit varius.', 'JKL',
                ...
                'PRIVATE', '{}', '{}', now() - INTERVAL '60 day', now() - INTERVAL '15 day');
