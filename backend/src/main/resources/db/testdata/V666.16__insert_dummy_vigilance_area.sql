...
-- 3. Date dans les trois prochains mois
        ...
        INSERT INTO public.vigilance_areas(id, comments, created_by, geom, is_draft, links, name,
                                           themes, visibility, linked_amps, linked_regulatory_areas, validated_at, created_at, updated_at)
        ...
        VALUES (2, 'Des dauphins partout', 'DEF',
                ...
                '{"AMP","Mixte"}',
                'PRIVATE', '{}', '{"625", "425"}', NOW() - INTERVAL '8 day', now() - INTERVAL '35 day', now() - INTERVAL '2 day');
        ...
        VALUES (4,
                ...
                '{"AMP","PN"}', 'PRIVATE', '{}', '{}', NOW() - INTERVAL '65 day', now() - INTERVAL '10 day', NULL);
        ...
        VALUES (9, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'JKL',
                ...
                '{}', '{}', NOW() - INTERVAL '21 day', now() - INTERVAL '25 day', NULL);
        ...
        -- outdated
        INSERT INTO public.vigilance_areas(id, comments, created_by, geom, is_draft, links, name,
                                           themes, visibility, linked_amps, linked_regulatory_areas, created_at, updated_at)
        VALUES (5,
                ...
                '{"AMP","PN"}', 'PRIVATE', '{}', '{}', now() - INTERVAL '40 day', now() - INTERVAL '19 day');
        ...
        VALUES (6, NULL, 'DEF',
          ...
          ]', 'Zone de vigilance 6', NULL, 'PUBLIC', '{}', '{}', now() - INTERVAL '60 day', now() - INTERVAL '55 day');
        ...
        VALUES (7,
                ...
                NULL, 'PUBLIC', '{}', '{}', now() - INTERVAL '40 day', now() - INTERVAL '39 day');
        ...
        VALUES (8, 'Phasellus ac elit eget ex blandit varius.', 'JKL',
                ...
                'PRIVATE', '{}', '{}', NOW() - INTERVAL '10 month', now() - INTERVAL '60 day', now() - INTERVAL '15 day');
