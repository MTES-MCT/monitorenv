...
VALUES
   ...
   false,
    ...
    (9,
     ...
     NULL,
     '[{"operatorName": "Good Company", "vesselName": "Mr le gérant" }]',
     ST_GeomFromText('MULTIPOINT((-4.40757547 48.65546589))', 4326),
     'NAMO',
     'Lorem LoremLorem ipsum dolor sit amet, consectetur adipiscing elit.',
     'OBSERVATION',
     NULL,
     ...
     NULL,
     '[{"operatorName": "Good Company", "vesselName": "Mr le gérant" }]',
     ST_GeomFromText('MULTIPOINT((-3.91241571 48.67428686))', 4326),
     'NAMO',
     'Lorem LoremLorem ipsum dolor sit amet, consectetur adipiscing elit.',
     'OBSERVATION',
     NULL,
     ...
     now() - INTERVAL '25 minutes',
     NULL,
     '3480657f-7845-4eb4-aa06-07b174b1da45', /* a control */
     'GHI'
    ),
     (11,
     2300011,
