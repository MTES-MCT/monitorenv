...
SELECT r.id,
       ...
       theme.name                                                   AS theme_level_1,
       subtheme.name                                                AS theme_level_2,
       CASE
...
FROM reportings r
         ...
         LEFT JOIN themes_reportings on themes_reportings.reportings_id = r.id
         LEFT JOIN themes_reportings subthemes_reportings on subthemes_reportings.reportings_id = r.id
         LEFT JOIN themes subTheme on subTheme.id = subthemes_reportings.themes_id
         LEFT JOIN themes theme on theme.id = themes_reportings.themes_id
