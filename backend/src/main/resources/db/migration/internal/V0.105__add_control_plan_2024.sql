...
(105,'Épave')
(106,'Activité et manifestation soumises à évaluation d''incidence Natura 2003')
...
SELECT setval('control_plans_themes_id_seq', (SELECT max(id) FROM control_plans_themes), true);
...
(132,106,'Existence d''une évaluation d''incidence Natura 2000',2024),
(133,106,'Prescriptions environnementales des manifestations / activités dans une zone Natura 2000',2024),
(134,106,'Travaux dans une zone Natura 2000',2024),
(135,106,'Charte Natura 2000',2024),
(136,106,'Autre (EIN2000)',2024),
...
(145,109,'Dragage',2024),
(146,109,'Clapage',2024),
(147,109,'Extraction de granulats ',2024),
(148,109,'Chantier marin',2024),
(149,109,'Chantier portuaire',2024),
(150,109,'Travaux réglementés par AMP',2024),
(151,109,'Autres travaux en mer',2024),
(152,110,'Arrêtés municipaux réglementant certaines activités avec un impact sur l''environnement marin ',2024),
(153,110,'Arrêtés du préfet de département réglementant certaines activités avec un impact sur l''environnement marin',2024),
(154,110,'Arrêtés du préfet maritime réglementant certaines activités avec un impact sur l''environnement marin ',2024),
(155,110,'Autres arrêtés réglementant certaines activités avec un impact sur l''environnement marin ',2024),
...
(168,114,'Autre',2024),
(169,115,'Pêche à pied de loisir',2024),
(170,115,'Pêche à pied professionnelle',2024),
(171,115,'Engin non-marqué',2024),
(172,115,'Autre (Pêche à pied)',2024),
