...
class JpaRegulatoryAreaRepositoryITests : AbstractDBTests() {
    ...
    fun `findRegulatoryAreaById Should return specific RegulatoryArea`() {
        ...
        assertThat(requestedRegulatoryArea.entity_name).isEqualTo(searchedRegulatoryArea.entity_name)
        ...
        assertThat(requestedRegulatoryArea.duree_validite).isEqualTo(searchedRegulatoryArea.duree_validite)
