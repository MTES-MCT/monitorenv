...
class JpaLegacyControlUnitRepositoryITests : AbstractDBTests() {
    @Autowired
    private lateinit var jpaLegacyControlUnitRepository: JpaLegacyControlUnitRepository

    @Test
    @Transactional
    fun `findAll should get all control units`() {
        // When
        val controlUnits = jpaLegacyControlUnitRepository.findAll()
