...
import fr.gouv.cacem.monitorenv.domain.use_cases.themes.fixtures.ThemeFixture.Companion.aSubTheme
...
class ThemesITest {
    ...
    fun `Should get all themes by regulatory area ids`() {
        ...
        mockMvc
            .perform(
                post("/bff/v1/themes/regulatoryAreas")
