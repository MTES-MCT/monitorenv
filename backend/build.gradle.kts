...
dependencies {
    ...
    implementation("org.http4k:http4k-client-apache:5.23.0.0")
    implementation("com.google.code.gson:gson:2.11.0")
    implementation("org.springframework.boot:spring-boot-starter-cache:3.3.1")
    implementation("com.github.ben-manes.caffeine:caffeine:3.1.8")
    implementation("org.springframework.security:spring-security-test:6.3.1")
    ...
    implementation("io.ktor:ktor-client-java-jvm:2.3.11")
    ...
    implementation("io.sentry:sentry-log4j2:7.10.0")
