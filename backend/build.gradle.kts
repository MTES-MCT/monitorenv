...
dependencies {
    ...
    implementation("org.springframework.boot:spring-boot-starter-json:3.4.0")
    ...
    implementation("org.http4k:http4k-client-apache:5.37.1.1")
    ...
    implementation("io.ktor:ktor-client-java-jvm:3.0.1")
