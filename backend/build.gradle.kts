...
dependencies {
    api("org.springframework.boot:spring-boot-starter-web:3.3.0")
    api("org.hibernate.validator:hibernate-validator:8.0.1.Final")
    api("jakarta.validation:jakarta.validation-api:3.1.0")
    api("org.springframework.boot:spring-boot-starter-actuator:3.3.0")
    api("org.springframework.boot:spring-boot-starter-json:3.3.0")
    ...
    api("org.springframework.boot:spring-boot-configuration-processor:3.3.0")
    ...
    api("org.springframework.boot:spring-boot-starter-cache:3.3.0")
    ...
    api("org.springframework.boot:spring-boot-starter-log4j2:3.3.0")
    ...
    runtimeOnly("org.springframework.boot:spring-boot-devtools:3.3.0")
