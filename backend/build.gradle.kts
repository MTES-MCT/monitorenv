...
dependencies {
    ...
    api("org.hibernate.validator:hibernate-validator:8.0.1.Final") // not used ?
    api("jakarta.validation:jakarta.validation-api:3.0.2") // not used ?
    api("com.neovisionaries:nv-i18n:1.29") // not used ?
    api("com.google.code.gson:gson:2.10.1") // not used ?
